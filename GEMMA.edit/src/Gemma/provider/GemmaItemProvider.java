...
/**
 * This is the item provider adapter for a {@link Gemma.Gemma} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GemmaItemProvider 
	 ...
	 * @generated
	 */
	public GemmaItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Gemma"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Gemma_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GemmaPackage.Literals.GEMMA__MACRO_OMS,
				 GemmaFactory.eINSTANCE.createMacroOm()));

		newChildDescriptors.add
			(createChildParameter
				(GemmaPackage.Literals.GEMMA__TRANSICIONES,
				 GemmaFactory.eINSTANCE.createTransicion()));

		newChildDescriptors.add
			(createChildParameter
				(GemmaPackage.Literals.GEMMA__TRANSICIONES,
				 GemmaFactory.eINSTANCE.createTrasicionEntreOmOm()));

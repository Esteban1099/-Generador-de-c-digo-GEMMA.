...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Expresion Not</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Gemma.impl.ExpresionNotImpl#getElementoExpresion <em>Elemento Expresion</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpresionNotImpl extends ElementoExpresionImpl implements ExpresionNot {
	/**
	...
	protected EClass eStaticClass() {
		return GemmaPackage.Literals.EXPRESION_NOT;
	}
	...
	public NotificationChain basicSetElementoExpresion(ElementoExpresion newElementoExpresion, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GemmaPackage.EXPRESION_NOT__ELEMENTO_EXPRESION, oldElementoExpresion, newElementoExpresion);
	...
	public void setElementoExpresion(ElementoExpresion newElementoExpresion) {
		if (newElementoExpresion != elementoExpresion) {
			...
			if (elementoExpresion != null)
				msgs = ((InternalEObject)elementoExpresion).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GemmaPackage.EXPRESION_NOT__ELEMENTO_EXPRESION, null, msgs);
			if (newElementoExpresion != null)
				msgs = ((InternalEObject)newElementoExpresion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GemmaPackage.EXPRESION_NOT__ELEMENTO_EXPRESION, null, msgs);
			msgs = basicSetElementoExpresion(newElementoExpresion, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GemmaPackage.EXPRESION_NOT__ELEMENTO_EXPRESION, newElementoExpresion, newElementoExpresion));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GemmaPackage.EXPRESION_NOT__ELEMENTO_EXPRESION:
